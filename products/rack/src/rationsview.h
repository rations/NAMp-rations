...
// size rather than to one global one. Three pages, three shapes: the head is 2.81:1 and nothing
...
private:
    ...
    // The radius stays a parameter with a default rather than becoming a constant. Every caller
